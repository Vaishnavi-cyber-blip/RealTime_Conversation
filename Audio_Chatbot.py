...
if __name__ == "__main__":
    ...
    if st.button("Audio"):
        ...
        if not GROQ_API_KEY:
            raise KeyError("GROQ_API_KEY environment variable is not set. Please add it to your .env file.")
        ...
        class LanguageModelProcessor:
            def __init__(self):
                ...
                # Load the system prompt from a file or define it directly
        ...
        # Define callback function to handle the input and reset it
        def submit_input():
            if st.session_state.input:
                response = llm_processor.process(st.session_state.input)
                st.session_state.chat_history.append((st.session_state.input, response))
